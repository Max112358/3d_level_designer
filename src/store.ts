...
export const useEditorStore = create<EditorState & EditorActions>(
  (set, get) => ({
    ...
    addProp: (prop) => {
      get().pushHistory();
      set((s) => ({
        level: { ...s.level, props: [...s.level.props, prop] },
      }));
    },
    ...
    removeProp: (index) => {
      ...
      set((s) => ({
        level: {
          ...s.level,
          props: s.level.props.filter((_, i) => i !== index),
        },
        selection:
          s.selection?.kind === "prop" && s.selection.index === index
            ? null
            : s.selection,
      }));
    },
    ...
    addTrigger: (trigger) => {
      get().pushHistory();
      set((s) => ({
        level: { ...s.level, triggers: [...s.level.triggers, trigger] },
      }));
    },
    ...
    removeTrigger: (index) => {
      ...
      set((s) => ({
        level: {
          ...s.level,
          triggers: s.level.triggers.filter((_, i) => i !== index),
        },
        selection:
          s.selection?.kind === "trigger" && s.selection.index === index
            ? null
            : s.selection,
      }));
    },
    ...
    addLight: (light) => {
      get().pushHistory();
      set((s) => ({
        level: { ...s.level, lights: [...s.level.lights, light] },
      }));
    },
    ...
    removeLight: (index) => {
      ...
      set((s) => ({
        level: {
          ...s.level,
          lights: s.level.lights.filter((_, i) => i !== index),
        },
        selection:
          s.selection?.kind === "light" && s.selection.index === index
            ? null
            : s.selection,
      }));
    },
    ...
    addAudio: (audio) => {
      get().pushHistory();
      set((s) => ({
        level: { ...s.level, audio: [...s.level.audio, audio] },
      }));
    },
    ...
    removeAudio: (index) => {
      ...
      set((s) => ({
        level: {
          ...s.level,
          audio: s.level.audio.filter((_, i) => i !== index),
        },
        selection:
          s.selection?.kind === "audio" && s.selection.index === index
            ? null
            : s.selection,
      }));
    },
    ...
    addEntity: (entity) => {
      get().pushHistory();
      set((s) => ({
        level: { ...s.level, entities: [...s.level.entities, entity] },
      }));
    },
    ...
    removeEntity: (index) => {
      ...
      set((s) => ({
        level: {
          ...s.level,
          entities: s.level.entities.filter((_, i) => i !== index),
        },
        selection:
          s.selection?.kind === "entity" && s.selection.index === index
            ? null
            : s.selection,
      }));
    },
    ...
    addItem: (item) => {
      get().pushHistory();
      set((s) => ({
        level: { ...s.level, items: [...s.level.items, item] },
      }));
    },
    ...
    removeItem: (index) => {
      ...
      set((s) => ({
        level: {
          ...s.level,
          items: s.level.items.filter((_, i) => i !== index),
        },
        selection:
          s.selection?.kind === "item" && s.selection.index === index
            ? null
            : s.selection,
      }));
    },
    ...
    clearAll: () => {
      get().pushHistory();
      set((s) => ({
        level: { ...emptyLevel(), name: s.level.name },
        selection: null,
      }));
    },
    ...
    loadLevel: (level) => {
      get().pushHistory();
      const currentName = get().level.name ?? "Untitled";
      const normalized: LevelData = {
        version: level.version ?? 1,
        name: level.name ?? currentName,
        cells: {},
        props: level.props ?? [],
    ...
    updateSelectionProperties: (props) => {
      ...
      set((s) => {
        ...
        switch (selection.kind) {
          case "prop":
            next.props[selection.index] = {
              ...next.props[selection.index],
              properties: {
                ...next.props[selection.index].properties,
                ...props,
              },
            };
            break;
          case "trigger":
            next.triggers[selection.index] = {
              ...next.triggers[selection.index],
              properties: {
                ...next.triggers[selection.index].properties,
                ...props,
              },
            };
            break;
          case "light":
            next.lights[selection.index] = {
              ...next.lights[selection.index],
              ...props,
            };
            break;
          case "audio":
            next.audio[selection.index] = {
              ...next.audio[selection.index],
              ...props,
            };
            break;
          case "entity":
            next.entities[selection.index] = {
              ...next.entities[selection.index],
              properties: {
                ...next.entities[selection.index].properties,
                ...props,
              },
            };
            break;
          case "item":
            next.items[selection.index] = {
              ...next.items[selection.index],
              properties: {
                ...next.items[selection.index].properties,
                ...props,
              },
            };
            break;
